...
var typed = new Typed(".typing-text", {
    strings: ["web development", "android development", "frontend development", "backend development", "web designing"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
s1.async=true;
s1.src='https://embed.tawk.to/62e0020254f06e12d88b71b9/1g8tgfrtc';
s1.charset='UTF-8';
